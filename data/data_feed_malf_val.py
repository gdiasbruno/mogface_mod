...
@register
class TrainFeedMALF_val(data.Dataset):
    __shared__ = ['out_bbox_anchor']
    __inject__ = ['dataset', 'collate_fn']
    def __init__(self, dataset, collate_fn=None, dataset_name='MALF_val', add_dsfd_label=False, \
...
if __name__ == '__main__': 
    from data.datasets_utils import malf_val
